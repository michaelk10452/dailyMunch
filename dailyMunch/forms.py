...
class NewSearchForm(forms.Form):
    keyword = forms.CharField(max_length=200, label='What food, cuisine, drink, etc. are you thinking about?', widget=forms.TextInput(attrs={'class':'w3-input w3-border w3-round-large w3-animate-input', 'style':"width:50%"}))
    ...
    distance_miles = forms.IntegerField(min_value=4, max_value=24, widget=forms.NumberInput(attrs={'class':'w3-input w3-border w3-round-large w3-animate-input', 'style':"width:50%"}))
